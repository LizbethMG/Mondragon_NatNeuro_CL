...
config.electrodes_to_keep = [5 6 7 8 13 14 15 16 17 18 19 20 29 30 31 32];
...
config.param.decision_threshold = -0.35;

% Minimum required percentage of simultaneous electrode detection.
config.param.percent_min = 0.8;
