...
config.electrodes_to_keep = [1 2 3 4 5 6 7 8 9 13 14 15 18 19];
...
config.param.decision_threshold = 0.1;

% Minimum required percentage of simultaneous electrode detection.
config.param.percent_min = 0.5;
