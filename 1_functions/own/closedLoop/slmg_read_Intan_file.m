function [amplifier_data, t_amplifier, board_dig_in_data, sample_rate, ...
    aux_input_data, t_aux_input, aux_sample_rate] = slmg_read_Intan_file(path, file)
...
aux_sample_rate = sample_rate/4;

fprintf(1, 'Done loading file!  Elapsed time: %0.1f seconds\n', toc);
fprintf(1, '\n');
