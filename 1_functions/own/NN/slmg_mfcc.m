function [ CC, FBE, frames ] = slmg_mfcc( speech, fs, Tw, Ts, ~, ~, R, M, N, L )
%This is a wrap of an existing function but deleting the preemphasis stage
...
%   Author: Kamil Wojcicki, September 2011
    ...
    frames = vec2frames( speech, Nw, Ns, 'cols', [], true );
